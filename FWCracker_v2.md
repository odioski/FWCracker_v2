...
heads up their asses when they built the POST. There should be no way to enter Cmd-Option-R to access either the firmware or the recovery system without first passing the 
